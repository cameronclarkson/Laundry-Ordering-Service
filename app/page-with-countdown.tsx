...
export default function ComforterCleaningLanding() {
  // Set the target date to April 30th of the current year
  const currentYear = new Date().getFullYear()
  const targetDate = new Date(`04/30/${currentYear} 23:59:59`)
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex h-10 w-full items-center justify-center bg-[#FF7A59] px-4 text-center text-base font-bold text-white">
        <div className="flex items-center space-x-2">
          <span>🔥 Only 25 spots at $99 — Offer ends 04/30! 🔥</span>
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm">
                    <Link href="#" className="text-[#FF7A59] hover:underline">
                      Enter ZIP to check availability →
                    </Link>
                  </div>
